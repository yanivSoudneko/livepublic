...
async function save(order) {
  try {
    ...
    console.log('🚀 ~ file: order.service.js ~ line 21 ~ save ~ newOrder', newOrder);
    return newOrder;
  } catch (error) {
    console.log('🚀 ~ file: order.service.js ~ line 22 ~ save ~ error', error);
  }
}
...
async function query(filterBy) {
  try {
    ...
    console.log('🚀 ~ file: order.service.js ~ line 39 ~ query ~ error', error);
  }
